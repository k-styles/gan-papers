...
class Discriminator(tf.keras.Model):
    def __init__(self, gen_struc=[([16,32], "relu"),([64,64], "relu"),([32,16], "relu")], output_activation="sigmoid", output_shape=(1,),
        ...
        self.discr_learning_rate = learning_rate
        self.optimizer = tf.keras.optimizers.Adam(learning_rate=self.discr_learning_rate, epsilon=epsilon, beta_1=beta_1, beta_2=beta_2, amsgrad=amsgrad, name=name, **kwargs)
