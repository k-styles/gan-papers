...
loaded_gen.load_weights("saved_models/generator_trained")
loaded_discr.load_weights("saved_models/discriminator_trained")
...
#     plt.show()
test_noise_sample = tf.random.uniform(shape=[100], minval=0.0, maxval=1.0)
print(loaded_discr(loaded_gen(test_noise_sample)))
# for i in range(gen_rows * gen_columns):
